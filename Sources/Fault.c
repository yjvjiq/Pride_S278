...
void errorSystemVoltageOV(void) 
{
    ...
    Error_Group4.Bit.F6_Bat_Over_V = Level;//Õû³µCAN¸³Öµ   
    //1¼¶´¦Àí
    Can554Byte2.Bit.F2_systemOV1=Error[1];//ÄÚ²¿CAN¸³Öµ
...
void errorCellVoltageOV(void)
{
    ...
    Error_Group2.Bit.F0_Cell_Over_V=Level;//Õû³µCAN¸³Öµ
    //1¼¶´¦Àí 
