...
## Generated on : Tue Jun 06 16:32:22 2017
## MATLAB Coder version: 3.1 (R2016a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/YoungMan_LT.exe
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = E:/模型留存/新版模型/YoungMan_LT（新版SOF等模型）/S278_code
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = YoungMan_LT_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = YoungMan_LT_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/YoungMan_LT.exe
...
INCLUDES_BUILDINFO = -I$(MATLAB_ROOT)/simulink/include/sf_runtime -I$(START_DIR)/YoungMan_LT_ert_rtw -I$(START_DIR) -IE:/模型留存/新版模型/YoungMan_LT（新版SOF等模型） -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=YoungMan_LT -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
SRCS = $(START_DIR)/YoungMan_LT_ert_rtw/YoungMan_LT.c
...
%.obj : $(START_DIR)/YoungMan_LT_ert_rtw/%.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")
