###########################################################################
## Makefile generated for Simulink model 'IsolationLow'. 
## 
## Makefile     : IsolationLow.mk
## Generated on : Wed Apr 26 11:01:37 2017
## MATLAB Coder version: 3.1 (R2016a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\IsolationLow.exe
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = E:\Pride\SimulinkModels\Models\ChargeTime\ChargeTimeEstimate
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = IsolationLow_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = IsolationLow_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\IsolationLow.exe
...
INCLUDES_BUILDINFO = $(MATLAB_ROOT)\simulink\include\sf_runtime;$(START_DIR)\IsolationLow_ert_rtw;$(START_DIR);E:\Pride\项目\青年6103\Models_6103;$(MATLAB_ROOT)\extern\include;$(MATLAB_ROOT)\simulink\include;$(MATLAB_ROOT)\rtw\c\src;$(MATLAB_ROOT)\rtw\c\src\ext_mode\common;$(MATLAB_ROOT)\rtw\c\ert
...
DEFINES_STANDARD = -DMODEL=IsolationLow -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
SRCS = $(START_DIR)\IsolationLow_ert_rtw\IsolationLow.c

MAIN_SRC = $(START_DIR)\IsolationLow_ert_rtw\ert_main.c
...
{$(START_DIR)\IsolationLow_ert_rtw}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\IsolationLow_ert_rtw}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
