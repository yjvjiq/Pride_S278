 ...
 * C/C++ source code generated on : Wed Apr 26 11:01:33 2017
 *
...
#define IsolationLow_IN_Fault20        ((uint8_T)5U)
#define IsolationLow_IN_Fault21        ((uint8_T)6U)
    ...
    switch (IsolationLow_DW.is_F2) {
     ...
     case IsolationLow_IN_Delay21:
      ...
      if (!(Res * 1000.0F > 57600.0F)) {
        ...
        if (IsolationLow_DW.temporalCounter_i2 >= 10) {
          /* Transition: '<S1>:69' */
          IsolationLow_DW.is_F2 = IsolationLow_IN_Fault20;
